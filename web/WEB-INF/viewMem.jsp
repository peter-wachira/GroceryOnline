...
<div id="main_container">
    ...
    <div class="right_header">Welcome Admin | <a href="#" class="logout"> 
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="myhome.com">Admin Home</a></li>
...
<!--            <td><a href="#"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
    ...
    <c:forEach var="ob" items="${memList}" >                  
                    <tr>
                        <c:choose>
                            <c:when test="${ob.status} eq 'Main Admin'">
                                <td><input type="checkbox" name="choose" value="${ob.id}" disabled="true"/></td>
                            </c:when>
                            <c:otherwise>
                        ...
                        <td> ${ob.id} </td>
                        <td> ${ob.status} </td>
                        <td><a href="viewAmember.com?id=${ob.id}"><img src="images/viewIcon.jpg" height="15px" width="15px" alt="" title="" border="0" /></a></td>
                        <!--<td> ${ob.address} </td>-->
    ...
    <span class="bt_green_lft"><button type="submit" name="activate" style="
    ...
    cursor: pointer;
    border-radius:7px;
    float:right;" >Activate</button></span>
     <a href="AddMem.com" class="bt_blue"><span class="bt_blue_lft"></span><strong>Add New Member</strong><span class="bt_blue_r"></span></a>
     <span class="bt_red_lft"><button type="submit" name="inactivate" style="
