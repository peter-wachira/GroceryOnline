...
<div id="main_container">
    ...
    <form  action="add_sub_from_cat.com"> 
...
-->    	<tr>
         ...
         <tr><td><label>Category ID </label></td>
             <td>
                 ${cat_id} <input type="hidden" value="${cat_id}" name="cid"/>      
             </td>
             
        </tr><!--
<!--        <tfoot>
    	<tr>
        	<td colspan="6" class="roundebd-foot-left"><em>Grocery Online is ISO 2000:2001 certified </em></td>
