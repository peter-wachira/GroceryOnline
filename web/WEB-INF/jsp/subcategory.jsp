...
<!--    		<div class="sidebar_search">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="viewAllProducts.com">View Products</a></li>
                    <li><a href="AddProduct.com">Add new Product</a></li>
                ...
                <a class="menuitem" href="">Add new Products</a>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Inactivate</th>
            
        </tr>
    </thead>
    <tbody>
        <c:forEach var="subcategory" items="${li}">
    	<tr>
        	<td><input type="checkbox" name="check" value="${subcategory.id}"/></td>
            <td>${subcategory.id}</td>
            <td>${subcategory.name}</td>
             <td>${subcategory.category.name}</td>
            <td>${subcategory.status}</td>
            <td><a href="view_subcat.com?cid=${subcategory.id}"><img src="images/viewIcon.jpg" height="15px" width="15px"/></a></td>

            <td><a href="edit_subcat.com?cid=${subcategory.id}"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="changesubstatus.com?cid=${subcategory.id}"><c:choose>
                                    <c:when test="${subcategory.status=='inactive'}">
        ...
        <a href="add_subcat.com" class="bt_green"><span class="bt_green_lft"></span><strong>Add new subcategory</strong><span class="bt_green_r"></span></a>
