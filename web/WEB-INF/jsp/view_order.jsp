...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
        ...
        <tr>
            <td>No of items</td>
            <td>${li.no_of_items}</td>
        </tr>
        <tr>
            <td>Items</td>
            <td><a href="order_items.com?oid=${li.id}">Your items</a></td>
        </tr>
        <tr>    
            <td>Total payment</td>
            <td>${li.total_payment}</td>
        </tr>
        <tr>
            <td>Status</td>
            <td>${li.status}</td>
...
<!--    	<tr>
       ...
       <span class="bt_green_lft"><button type="submit" name="back" 
                                           style="
    ...
    float:right;">
     ...
     <!--<a href="add_subcat_from_cat.com?cid=${li.id}" class="bt_blue"><span class="bt_blue_lft"></span><strong>Add new subcategory</strong><span class="bt_blue_r"></span></a>-->
