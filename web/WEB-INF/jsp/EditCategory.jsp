...
<div id="main_container">
    ...
    width: 200px;
       ...
       ">
            ...
            <li><img src="images/suzy.png" width="200px" height="200px"/>
            </li>
...
<!--            <td><a href="#"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
        ...
        -->
                ...
                <tr >
                    <td>Category Name </td>
                    <td><input type="text" name="catname" value="${li.name}"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <input type="hidden" name="cid" value="${li.id}"/>
                    </td>
                </tr>
                <tr>
                    <td>Image :</td>
