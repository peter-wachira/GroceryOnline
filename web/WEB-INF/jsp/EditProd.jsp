...
<div id="main_container">
    ...
    width: 200px;
       ...
       ">
            ...
            <li>
                <img src="images/suzy.png" width="180px" height="180px"/>
            </li>
    ...
    <h2>Edit Product</h2> 
    <form action="editProduct.com" method="post" enctype="multipart/form-data">
...
<!--            <td><a href="#"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
        ...
        -->
                ...
                <tr >
                    <td>Product Name </td>
                    <td><input type="text" name="prodname" value="${prod.pname}"/></td>
                </tr>
                <tr>
                    <td>Price </td>
     ...
     <!--<a href="addingMem.com" class="bt_blue"> </a>-->
         <!--<span class="bt_blue_lft"></span><strong></strong><span class="bt_blue_r"></span>-->
     <span class="bt_blue_lft"><button type="submit" name="update" style="
