...
<!--            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="ViewAllProducts.com">Manage products</a></li>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
        <c:forEach var="category" items="${li}">
    	<tr>
        	<td><input type="checkbox" name="check" value="${category.id}"/></td>
            <td>${catego.id}</td>
            <td>${category.name}</td>
            <td>${category.status}</td>
            <td><a href="view_cat.com?cid=${category.id}"><img src="images/viewIcon.jpg" height="15px" width="15px"/></a></td>

            <td><a href="EditCategory.com?id=${category.id}"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <c:choose>
                        <c:when test="${category.status=='Active'}">
                            <td><a href="changeCatStatus.com?id=${category.id}" class="ask"><img src="images/Active.jpg" height="15px" width="15px"alt="" title="" border="0" /></a></td>
                        </c:when>  
                        <c:when test="${category.status=='inactive'}">
                             <td><a href="changeCatStatus.com?id=${category.id}" class="ask"><img src="images/inactiveXRED.png" height="15px" width="15px"alt="" title="" border="0" /></a></td>
                        </c:when>               
    ...
    border-radius:7px;
    float:right;">
        Inactivate<span class="bt_green_r"></span></button>
    ...
    border-radius:7px;
    float:right;">
        </span>Activate<span class="bt_green_r"></span></button>
