...
<form action="updateMem.com" method="get" >         
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    

        <tr>
            <td>UserName</td>
            <td> <input type="text" name="username" value="${mid.username}"/></td>
        </tr>
        <tr>
            <td>Password</td>
       ...
       <tr>
            <td>Email Id</td>
            <td><input type="email" name="email" value="${mid.email}"/></td>
        </tr>
        <tr>
            <td>Address</td>
            <td><input type="text" name="address" value="${mid.address}"/></td>
        </tr>
        <tr>
            <td>Phone No.</td>
            <td><input type="text" name="phone" value="${mid.phoneno}"/></td>
        </tr>
        <tr>
            <td>Status</td>
            <td> 
        ...
        <tr>
            <td>Date of Birth</td>
            <td><input type="date" name="dob" value="${mid.dob}"/></td>
        </tr>
        <tr>
            <td><input type="hidden" name="id" value="${mid.id}" /></td>
        </tr>
