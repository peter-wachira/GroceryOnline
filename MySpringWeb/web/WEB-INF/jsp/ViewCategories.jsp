...
<!--    		<div class="sidebar_search">
            ...
            <div class="sidebarmenu">
                ...
                <a class="menuitem" href="">Categories</a>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    <c:forEach var="ob" items="${catList}" >                  
                    <tr>
                        <td><input type="checkbox" name="choose" value="${ob.id}"/></td>
                        <td> ${ob.name}</td>
                        <td> ${ob.id} </td>
                        <td><a href="view_cat.com?cid=${ob.id}"><img src="images/viewIcon.jpg" height="15px" width="15px" alt="" title="" border="0" /></a></td>
                        
                        <td><a href="EditCategory.com?id=${ob.id}"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
                        <c:choose>
                        <c:when test="${ob.status=='active'}">
                            <td><a href="changeCatStatus.com?id=${ob.id}" class="ask"><img src="images/Active.jpg" height="15px" width="15px"alt="" title="" border="0" /></a></td>
                        </c:when>  
                        <c:when test="${ob.status=='inactive'}">
                             <td><a href="changeCatStatus.com?id=${ob.id}" class="ask"><img src="images/inactiveXRED.png" height="15px" width="15px"alt="" title="" border="0" /></a></td>
                        </c:when>               
...
<span class="bt_green_lft"><strong><button type="submit" name="activate" style="
    ...
    float:right;" >Inactivate</button>
     ...
     <a href="add_cat.com" class="bt_blue"><span class="bt_blue_lft"></span><strong>Add Category</strong><span class="bt_blue_r"></span></a>
