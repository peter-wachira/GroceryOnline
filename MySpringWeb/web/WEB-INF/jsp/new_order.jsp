...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">No. of items</th>
            <th scope="col" class="rounded">Total Payment</th>
            <th scope="col" class="rounded">Status</th>
            <th scope="col" class="rounded">Order Date</th>
            <th scope="col" class="rounded">Order status Date</th>
    	...
    	<tr>
            ...
            <td>${order.status}</td>
            <td>${order.date}</td>
            <td>${order.stat_date}</td>
            
                  
            <td><a href="view_order.com?oid=${order.id}"><img src="images/viewIcon.jpg" height="15px" width="15px"/></a></button></td>
            <td><a href="edit_order.com?oid=${order.id}"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
...
<!--        <span class="bt_green_lft"><button type="submit" name="update" style="
    ...
    border-radius:7px;
    float:right;">
        </span>Inactivate<span class="bt_green_r"></span></button>-->
     <!--<a href="#" class="bt_blue"><span class="bt_blue_lft"></span><strong>View orders from customer</strong><span class="bt_blue_r"></span></a>-->
