...
<div id="main_container">
    ...
    <%--<form:form method="GET" action="add_categ.com" modelAttribute="category">--%> 
    <form  action="add_category.com"> 
        
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    
<!--        <tr>
            <td><label>Image</label></td>
            <td><input name="image"></input> </td>
...
<!--        <tfoot>
    	<tr>
        	<td colspan="6" class="rounded-foot-left"><em>Grocery Online is ISO 2000:2001 certified </em></td>
...
<!--            <td><button type="submit" name="update" style="
                        ...
                        cursor: pointer;
                        border-radius: 50%;
                        "> <img src="images/viewIcon.jpg" width="15px" height="15px"/></button></td>
   ...
   <span class="bt_green_lft"><button type="submit" name="back" style="
                                           background-color:chartreuse; /*kind of green*/ 
    border: none;
    color: white;
